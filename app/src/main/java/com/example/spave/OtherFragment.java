...
public class OtherFragment extends Fragment {
    private Button fact_button, promo_button, sale_button, notes_button;
    ...
    private void buttons(){
        ...
        notes_button = getActivity().findViewById(R.id.notes_button);
    ...
    private void dateSetter(){
        ...
        // getting date
        String getDay = new SimpleDateFormat("dd", Locale.getDefault()).format(new Date());
        ...
        if (String.valueOf(day.charAt(0)).equals("0")){
            day = day.deleteCharAt(0);
        }

        // setting date
        String date = dayOfWeek + ", " + monthsList[monthIndex] + " " + day.toString();
